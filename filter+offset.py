...
for fil in files:
    ...
    xarr= butter_lowpass_filter(xarr,3, 21.5,1)
    yarr= butter_lowpass_filter(yarr,3, 21.5,1)
    zarr= butter_lowpass_filter(zarr,3, 21.5,1)



    # xarr= butter_highpass_filter(xarr,0.00001, 21.5,3)
    # yarr= butter_highpass_filter(yarr,0.00001, 21.5,3)
    # zarr= butter_highpass_filter(zarr,0.00001, 21.5,3)
